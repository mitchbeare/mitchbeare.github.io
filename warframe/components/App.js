          ...
          <div className="cell-6">
            <ol>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <input id="earthitem1" type="checkbox" />
                  ...
                  <li>
                    <input id="earthitem2" type="checkbox" />
                  ...
                  <li>
                    <input id="earthitem3" type="checkbox" />
                  ...
                  <li>
                    <input id="earthitem4" type="checkbox" />
                  ...
                  <li>
                    <input id="earthitem6" type="checkbox" />
